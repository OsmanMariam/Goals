...
export class GoalComponent implements OnInit {
  ...
  goals: Goal[] =[
    new Goal(1,"Watch Finding Nemo","Find an online version and watch Merlin his son",new Date(2020,3,14)),
    new Goal(2,"Buy Cookies","I ahave to buy cookies for the parrot",new Date(2019,6,9)),
